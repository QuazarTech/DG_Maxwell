...
def lagrange_basis_coeffs(x):    
    '''
    Returns the coefficients of the Lagrange basis polynomials for a given set
    of x nodes.
    ...
    ----------
    x : arrayfire.Array
        An arrayfire array consisting of the :math: `x` nodes using which the
    ...
    '''
    X = np.array(x)  #poly1d can be used only for numpy arrays
