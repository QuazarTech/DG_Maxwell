...
def numerical_A_matrix():
    ...
    identity_matrix = af.identity(gvar.N_LGL ** 2, gvar.N_LGL ** 2,\
                                                        dtype = af.Dtype.f64)
    A_matrix        = af.broadcast(utils.multiply, weight_array, identity_matrix)
