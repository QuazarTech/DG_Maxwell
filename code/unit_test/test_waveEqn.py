...
def test_isoparam_x():
    ...
    (2, 2), (1, 2). We expect the origin in the xi-eta space to be mapped
    to coordinates (1, 1).
    '''
    threshold = 1e-14
    ...
    test_nodes1 = af.interop.np_to_af_array(np.array([[1, 2], [0.5, 1], [0, 0],\
                                   [2, 0], [4, 0], [3.5, 1], [3, 2], [2, 2]]))
    x_nodes1 = test_nodes1[:, 0]
    y_nodes1 = test_nodes1[:, 1]       
    print(wave_equation.isoparam_x(x_nodes1, xi, eta), wave_equation.isoparam_y(y_nodes1, xi, eta)) 
